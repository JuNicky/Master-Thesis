...
def main():
    ...
    if args.content_folder_name and args.documents_directory and args.evaluation_directory:
    ...
    json_file_path = os.path.join(evaluation_directory, f'evaluation_request_{content_folder_name}_no_requests.json')
