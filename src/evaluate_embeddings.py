...
def main():
    ...
    if args.evaluation_file and args.embedding_provider and args.embedding_author and args.embedding_function and args.collection_name and args.vector_db_folder:
    ...
    for index, (key, value) in enumerate(evaluation.items()):
        ...
        pages_result = get_first_n_unique_ids_by_type(source_documents, n_pages, "page_id")
        documents_result = get_first_n_unique_ids_by_type(source_documents, n_documents, "document_id")
        dossiers_result = get_first_n_unique_ids_by_type(source_documents, n_dossiers, "dossier_id")
