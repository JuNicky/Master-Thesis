...
class Querier:
    ...
    def __init__(self, llm_type=None, llm_model_type=None, embeddings_provider=None, embeddings_model=None,
        ...
        self.embeddings = embeddings.getEmbeddings(self.embeddings_provider,
    ...
    def get_documents_with_scores(self, question: str) -> List[Tuple[Document, float]]:
        most_similar_docs = self.vector_store.similarity_search_with_relevance_scores(question, k=25, filter=self.filters)
