...
def main():
    ...
    woo_data_subset = pd.read_csv(f'./{documents_directory}/{content_folder_name}/woo_merged.csv.gz')
    ...
    print(f"[Info] ~ Result BM25 document similarity for {content_folder_name} saved.", flush=True)
